       ...
       <div class="grid-search-div clearfix no-padding">
             <div class="pull-left" style="margin-left: 0%;margin-top: 12px;"> 
               <font color=#FFFFFF> 日&nbsp;&nbsp;&nbsp;&nbsp;期：</font>
           		<input type="text" class="form-control" id="monthAccountPeriod1"  placeholder="请输入日期" style="width: 140px;top: -20px;left: 50px;height:25px;" data-date-format="yyyy-mm" >
            </div>
            ...
            <div style="width:auto;top: 11.4%;right:76%;position: absolute;">
            	<button class="btn btn-primary" id="getReportForm4Export">导出</button>
            </div>
