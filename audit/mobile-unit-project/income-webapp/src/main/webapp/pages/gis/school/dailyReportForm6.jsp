...
<body>
    <div  style="height: 100%;width: 100%;text-align: center;"><font color="#fffff" size="5">高校市场份额日报表</font></div>
       ...
       <div class="grid-search-div clearfix no-padding">
             <div class="pull-left" style="margin-left: 0%;margin-top: 7px;"> 
               <font color=#FFFFFF> 日&nbsp;&nbsp;&nbsp;&nbsp;期：</font>
           		<input type="text" class="form-control" id="dailyAccountPeriod6"  placeholder="请输入日期" style="width: 140px;top: -20px;left: 50px;height:25px;" data-date-format="yyyy-mm-dd" >
            </div>
            <div style="width:auto;top: 10.5%;right:81%;position: absolute;">
            	<button class="btn btn-primary" id="dailySearchList6">查询</button>
            </div>
             <div style="width:auto;top: 10.5%;right:76%;position: absolute;">
            	<button class="btn btn-primary" id="getReportForm14Export">导出</button>
            </div>
        </div>
        <div class="left">
            <table id="dailyReportForm6InfoListGrid"></table>
	         <div id="dailyReportForm6InfoListPagers"></div> 
        </div>
    </div>
</body>
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/gis/school/dailyReportForm6.js"></script>
</html>