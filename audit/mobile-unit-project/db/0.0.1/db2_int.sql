...
(
  ...
  tree_code  VARCHAR(500),
  tree_level INTEGER,
  parent_id  VARCHAR(50)
);
insert  INTO SYS_CODE (id,code_type,code_key,code_value,tree_code,tree_level,parent_id)
 values 
