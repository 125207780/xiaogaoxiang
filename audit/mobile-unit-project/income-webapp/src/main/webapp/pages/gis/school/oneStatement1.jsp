...
<body>
    <div  style="height: 100%;width: 100%;text-align: center;"><font color="#fffff" size="5">校园一经 月报表</font></div>
       ...
       <div class="grid-search-div clearfix no-padding">
             <div class="pull-left" style="margin-left: 0%;margin-top: 7px;"> 
               <font color=#FFFFFF> 日&nbsp;&nbsp;&nbsp;&nbsp;期：</font>
           		<input type="text" class="form-control" id="oneAccountPeriod1"  placeholder="请输入日期" style="width: 140px;top: -20px;left: 50px;height:25px;" data-date-format="yyyy-mm" >
            </div>
            <div style="width:auto;top: 10.5%;right:81%;position: absolute;">
            	<button class="btn btn-primary" id="oneSearchList1">查询</button>
            </div>
             <div style="width:auto;top: 10.5%;right:76%;position: absolute;">
            	<button class="btn btn-primary" id="getReportForm11Export">导出</button>
            </div>
        </div>
        <div class="left">
            <table id="oneStatement1InfoListGrid"></table>
	         <div id="oneStatement1InfoListPagers"></div> 
        </div>
    </div>
</body>
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/gis/school/oneStatement1.js"></script>
</html>