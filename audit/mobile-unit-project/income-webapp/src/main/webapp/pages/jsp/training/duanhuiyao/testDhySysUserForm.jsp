...
<div id="testDhySysUserForm">
	...
	<div class="clearfix formGroup">
		...
		<div class="col-sm-4">
			...
			<button class="btn btn-primary" id="testDhyShowOrgWin">选择</button>
		</div>
	</div>
</div>
<script src="<%=request.getContextPath()%>/pages/jsp/training/duanhuiyao/testDhySysUserForm.js"></script>
