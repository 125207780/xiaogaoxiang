...
(function() {
    ...
    BMapLib.SearchControl=  function(orgId) {
    ...
    SearchControl.prototype.initialize = function(map) {
        ...
        // 创建一个DOM元素
  	  var div =$("<div  style='left: 10px; top: 10px; right: auto; bottom: auto; position: absolute; -ms-text-size-adjust: none; z-index: 2;' ></div>")
 	...
 	div.append(totalDiv);
  	...
  	textInput.autocomplete({
	      ...
	      source: function(request, response) {
	    	  ...
	    	  if(request.term!=""){
	    	  $.ajax({
	    		  url:$.cxt+"/gridCommon/initSearchPlaceNameInter",
    ...
    return polygon;
  	...
  	function search(keyword,page){ 
  	  ...
  	  searchArr=[];
  	  $.ajax({
  			url : $.cxt + "/gridCommon/selectSearchListInter", 
...
//  							 
    ...
    BMapLib.SearchControl= SearchControl; // 向命名空间注册.
})()
