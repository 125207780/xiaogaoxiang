...
var topLeftAndRight = function(obj) {
	...
	var html = "<select id=\"" + divId + "Left\" name=\"" + divId + "\" multiple style=\"width: " + width + " !importtant;height: " + height + "px;float: left;border:1px solid #ccc;color:#666\">";
	...
	html += "</div>";
	html += "</div>";
	html += "<select id=\"" + divId + "Right\" name=\"" + divId + "\" multiple style=\"width: " + width + " !importtant;height: " + height + "px;float: left;border:1px solid #ccc;color:#666;\">";
