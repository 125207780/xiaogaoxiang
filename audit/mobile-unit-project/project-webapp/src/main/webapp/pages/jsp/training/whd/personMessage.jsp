...
<div id="UserForm">
	<div class="clearfix formGroup">
		...
		<div class="col-sm-4">
			<input value="${user.userId }" type="hidden" placeholder="员工编号"
				class="formField required" id="loginId" name="userId" /> <input
				value="${user.user_Password }" type="text" placeholder="密码"
	...
	<div class="clearfix formGroup">
		...
		<div class="col-sm-4">
			<input value="${user.user_Name }" type="text" placeholder="员工姓名"
	...
	<div class="clearfix formGroup">
		...
		<div class="col-sm-4">
			<input value="${user.user_Address }" type="text" placeholder="住址"
