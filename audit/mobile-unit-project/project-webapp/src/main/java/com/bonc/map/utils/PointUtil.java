package com.bonc.map.utils;

import java.text.DecimalFormat;

public class PointUtil {
	// private final static double EARTHRADIUS = 6370996.81;
	private final static double[] MCBAND = { 12890594.86, 8362377.87, 5591021, 3481989.83, 1678043.12, 0 };
	...
	private static double[] convertor(double[] point, double[] ll2mc) {
		...
		double y = ll2mc[2] + ll2mc[3] * a + ll2mc[4] * a * a + ll2mc[5] * a * a * a + ll2mc[6] * a * a * a * a + ll2mc[7] * a * a * a * a * a
				+ ll2mc[8] * a * a * a * a * a * a;
