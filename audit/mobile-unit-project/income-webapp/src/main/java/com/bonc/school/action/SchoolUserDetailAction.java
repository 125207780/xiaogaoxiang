...
public class SchoolUserDetailAction {
	...
	public PageJqGrid<SchoolUserDetail> findSchoolUserDetailInfo(SchoolUserDetail basicUnitInfo ,Integer page, Integer rows){
		...
		Page<SchoolUserDetail> basicUnit = (Page<SchoolUserDetail>) this.schoolUserDetailService.getMapper().findSchoolUserDetailInfo(basicUnitInfo,AppTypeIdList);
	...
	public void exportExcel(HttpServletResponse response,int statisMonth,String actviTypeId,String usrType,String feeLevelId,String gprsLevelId,String schoolId,String voiceLevelId,String appTypeId,String discFeeId) {
		...
		try {
			...
			List<SchoolUserDetail> empList = schoolUserDetailService.selectAll(statisMonth, actviTypeId, usrType, feeLevelId, gprsLevelId, schoolId,voiceLevelId,AppTypeIdList,discFeeId);
