...
function oneStatement2DetailListGrid(){
	var lastMonth = oneInitDate2();
	   ...
	   grid.jqGrid({ 
		   ...
		   height : 200,
		   width:($("#gview_oneStatement2InfoListGrid").width()),
		   autowidth : false,
		   ...
		   colModel: [ 
			...
			gridComplete : setNiceScrollOne2,
	 ...
	 //导出
		$("#getReportForm12Export").click(function(){
			var statisMonth = encodeURI(encodeURI($("#oneAccountPeriod2").val()));
			window.location.href=$.cxt +"/getReportForm/getReportForm12Export?statisMonth="+statisMonth;
		})
}
...
function setNiceScrollOne2(){
	...
	$('#gbox_oneStatement2InfoListGrid .ui-jqgrid-view .ui-jqgrid-bdiv').getNiceScroll().resize()
	$("#gbox_oneStatement2InfoListGrid .ui-jqgrid-view .ui-jqgrid-bdiv").niceScroll({
