$(function(){
	// 用jquery $("#t1").html("22");
	// 用js是document.getElementById("td1").innerHTML = "22";
	//这里是要获取对象的值，才能传递到后台，不然ajax方法进不去
	//var uid = $("#uid").val();
	var id = "CS123456";
	$.ajax({
	...
	$.ajax({
		...
		dataType : "json",
	 	...
	 	/*	{STUDENT_SCALE=111111111, SCHOOL_NAME=学校名称, EDUCATION_LEVEL=11111111,
	 	 * 	 CAMPUS=111111, PHYSICAL_ID=id城市,MANAGER_DEPT=111111111, 
	 	 *   ADDR=111111, TOTAL_STUDENT_SCALE=111111111, ORG_ID=111111}*/
	 		//如果有值
	 		if (mapObj) {
