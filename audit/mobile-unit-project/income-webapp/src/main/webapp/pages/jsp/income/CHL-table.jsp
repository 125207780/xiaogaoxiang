...
%>  
<style>
	#CHL_table .ui-th-ltr, .ui-jqgrid .ui-jqgrid-htable th.ui-th-ltr{
		text-align:center !important;
	}  
</style>
 <input type="hidden" id = "index3" value="<%=place%>">
	 <div  style="width:100%;height:100%;position: relative;"> 
		<div style="width:100%;height:30px;">
			...
			<div style="position: absolute;top: 35px;bottom: 2px;overflow: hidden;left: 0px;right: 0px;">				
			<table id="CHL_table"></table>
			<div id="CHL_pager"></div>
		</div>
	</div>
 
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/jsp/income/CHL-table.js"></script>
