...
public class SchoolMapAction {
	...
	/*
	 * @RequestMapping(value = "/getMapRight1", method = RequestMethod.POST,
	 * produces = "application/json;charset=UTF-8")
	 * 
	 * @ResponseBody public Page<Map<String, Object>> getMapRight1(Integer page,
	 * Integer rows,String statisMonth) {
	 * 
	 * PageHelper.startPage(page, rows); List<Map<String, Object>> infoData =
	 * schoolMapService.getMapRight(statisMonth); Page<Map<String, Object>>
	 * pageMap = new Page<Map<String, Object>>(new PageInfo<Map<String,
	 * Object>>(infoData)); return pageMap;
	 * 
	 * }
	 */
