...
function dailyReportForm2DetailListGrid(){
	var lastMonth = dailyInitDate2();
	   ...
	   grid.jqGrid({ 
		   ...
		   height : 200,
		   width:($("#gview_dailyReportForm2InfoListGrid").width()),
		   autowidth : false,
		   ...
		   colModel: [ 
			...
			gridComplete : dailyReportForm2setNiceScroll,
	 ...
	 //查询按钮
		...
		//导出
		$("#getReportForm3Export").click(function(){
			var statisMonth = encodeURI(encodeURI($("#AccountPeriod3").val()));
			window.location.href=$.cxt +"/getReportForm/getReportForm3Export?statisMonth="+statisMonth;
		})
}
...
function dailyReportForm2setNiceScroll(){
