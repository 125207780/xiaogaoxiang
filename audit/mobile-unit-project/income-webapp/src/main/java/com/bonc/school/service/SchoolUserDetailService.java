...
public class SchoolUserDetailService {
	...
	public List<SchoolUserDetail>  selectAll(int statisMonth,String actviType,String usrType,String feeLevel,String gprsLevel,String schoolId,String voiceLevel,List<String> AppTypeIdList,String discFeeId){
		return schoolUserDetailMapper.selectAll(statisMonth, actviType, usrType, feeLevel, gprsLevel, schoolId,voiceLevel,AppTypeIdList,discFeeId);
	}
