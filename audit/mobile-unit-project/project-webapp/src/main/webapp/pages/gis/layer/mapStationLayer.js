...
(function() {
     ...
     */
	var StationLayer = BMapLib.StationLayer = function(setRange, uId, poiInfo, rangeInfo, orgId) {
    	this.conf = {};
    	this.overlayList = [];
	...
	StationLayer.prototype.initialize = function(map) {
    	...
    	// 判断是否是选择的基础单元，然后先将整个基础单元的信息给移除，再新增加周边基础单元信息
 	    for(var i = 0; i < allOverlay.length; i++) {
 	    	if("station" == allOverlay[i].poiInfo || "allStation" == allOverlay[i].poiInfo || "ALL_STATION" == allOverlay[i].rangeInfo) {
...
//						}
	...
	// 向命名空间注册.
	BMapLib.StationLayer = StationLayer; 
})()
