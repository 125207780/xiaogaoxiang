...
<body>
    <div  style="height: 100%;width: 100%;text-align: center;"><font color="#fffff" size="5">校园异网用户明细数据 月报表</font></div>
    <div style="height: 100%;width: 100%;" id="momthReport2">
       <div class="grid-search-div clearfix no-padding">
       		 <div class="pull-left" style="margin-left: 10.8%;margin-top: 7px;"> 
                <font color=#FFFFFF>地&nbsp;&nbsp;&nbsp;&nbsp;区:</font>
               <select  style="width:140px" size="small" id="cityName2" onchange="uppSchool2()" >
               </select>
            </div>
       		<div class="pull-left" style="margin-left:3%;margin-top: 7px;"> 
                <font color=#FFFFFF>学&nbsp;&nbsp;&nbsp;&nbsp;校:</font>
               <select  style="width:80px" size="small" id="schoolName2">
               	<option>请选择...</option>	
               </select>
            </div>
             <div class="pull-left" style="margin-left: 3%;margin-top: 12px;"> 
               <font color=#FFFFFF> 日&nbsp;&nbsp;&nbsp;&nbsp;期：</font>
           		<input type="text" class="form-control" id="monthAccountPeriod4"  placeholder="请输入日期" style="width: 140px;top: -20px;left: 50px;height:25px;" data-date-format="yyyy-mm" >
            </div>
            <div style="width:auto;top: 11.4%;right:40%;position: absolute;">
            	<button class="btn btn-primary" id="monthSearchList4">查询</button>
            </div>
             <div style="width:auto;top: 11.4%;right:35%;position: absolute;">
            	<button class="btn btn-primary" id="getReportForm10Export">导出</button>
            </div>
        </div>
        <div class="left" style="width: 100%;">
            <table id="monthReportForm4InfoListGrid"></table>
	         <div id="monthReportForm4InfoListPagers"></div> 
        </div>
    </div>
</body>
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/gis/school/monthReportForm4.js"></script>
</html>