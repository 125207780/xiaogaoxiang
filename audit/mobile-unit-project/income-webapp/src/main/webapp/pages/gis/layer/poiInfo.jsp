            	...
            	<div id="myCarousel" class="carousel slide" style="height: 370px;" data-interval=false>
					...
					<div class="carousel-inner">
						...
						<div class="modal-headers">
			                ...
			                <h4 class="modal-title" id="myModalLabel">渠道基础信息<%=uid %></h4>
			            </div>
							...
							<ul class="channelBaseInfo clearfix">
								<li class="channelBaseInfoList clearfix">
									<div class="channelBaseInfoDiv1 clearfix">
										<div class="channelBaseInfoLC">日有线宽带发展：</div>
										<div class="channelBaseInfoR">1</div>
									</div>
								</li>
								<li class="channelBaseInfoList clearfix">
									<div class="channelBaseInfoDiv1 clearfix">
										<div class="channelBaseInfoLC">日电视宽带发展：</div>
										<div class="channelBaseInfoR">0</div>
									</div>
								</li>
								<li class="channelBaseInfoList clearfix">
									<div class="channelBaseInfoDiv1 clearfix">
										<div class="channelBaseInfoLC">日本月累计体内4G终端销量：</div>
										<div class="channelBaseInfoR">1</div>
									</div>
								</li>
								<li class="channelBaseInfoList clearfix">
									<div class="channelBaseInfoDiv1 clearfix">
										<div class="channelBaseInfoLC">日本月累计飞享50元以上流量模组办理量：</div>
										<div class="channelBaseInfoR">100</div>
									</div>
								</li>
								<li class="channelBaseInfoList clearfix">
									<div class="channelBaseInfoDiv1 clearfix">
										<div class="channelBaseInfoLC">日本月累计咪咕爱看活跃用户发展量(M)：</div>
										<div class="channelBaseInfoR">0</div>
									</div>
								</li>
								<li class="channelBaseInfoList clearfix">
									<div class="channelBaseInfoDiv1 clearfix">
										<div class="channelBaseInfoLC">日本月累计放号量：</div>
										<div class="channelBaseInfoR">100</div>
									</div>
								</li>
							</ul>
