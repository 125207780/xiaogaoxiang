...
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/js/multiselect/bootstrap-multiselect.js"></script>
<link rel="stylesheet" href="<%=request.getContextPath()%>/pages/js/multiselect/bootstrap-multiselect.css" type="text/css"/>
    <style>
        html,body{
            height: 100%;
            width:100%;
...
<body>
    <div style="height: 100%;width: 100%;" id="pp">
       <div class="grid-search-div clearfix no-padding">
            ...
            <!--<br>-->
            <div class="pull-left" style="margin-left: 10px;">
                <font color=#FFFFFF>ARPU分档（剔除折让后）：</font>
               <select  style="width:80px" size="small" id="incomeFiling">
               </select>
            </div>
            <div class="pull-left" style="margin-left: 10px;" >
                <font color=#FFFFFF>APP偏好：</font>
               <select   style="width:80px !important;" size="small" id="APPFiling" class="multiselect" multiple="multiple">
               </select>
            </div>
            ...
            <div class="pull-left" style="margin-left: 14px;margin-top: 7px;">
             ...
             <div class="pull-left" style="margin-left:8px;margin-top: 7px;"> 
               <font color=#FFFFFF> 账&nbsp;&nbsp;&nbsp;&nbsp;期：</font>
           		<input type="text" class="form-control" id="shcoolUserAccountPeriod1"  placeholder="请输入日期" style="width: 45%;top: -20px;left: 76px;height:25px;" data-date-format="yyyy-mm" >
            </div>
