	...
	<div class="page-content clearfix">
		<div class="col-sm-12 grid-full">
			<div class="grid-search-div" id="gridSearch">
				<input type="hidden" class="searchField" id="pageType" name="pageType" value="participate" />
...
<script src="<%=request.getContextPath()%>/pages/jsp/workbench/workorder/participateWorkOrder.js"></script>
</html>