	...
	showWindow : function(obj) {
		...
		$.ajax({
			...
			success : function(data) {
				...
				html = '<div class="modal fade in" id="'+id+'" tabindex="-1" role="dialog" data-keyboard="false"  aria-hidden="true"   data-backdrop="static"  style="overflow:hidden; display:block;max-height:'+windowHeight+'px" >'+
