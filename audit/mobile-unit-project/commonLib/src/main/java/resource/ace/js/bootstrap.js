...
+function ($) {
  ...
  Modal.prototype.show = function (_relatedTarget) {
    ...
    if(navigator.appName == "Microsoft Internet Explorer" && navigator.appVersion .split(";")[1].replace(/[ ]/g,"")=="MSIE8.0")
	{
    	...
    	if(this.$element.find("input").length > 0 && this.$element.find("input").hasClass("date-picker")){
    	   this.$element.find("input:not(.date-picker)").each(function(index,element){
 			   $(this).focus().blur();
 		   });
