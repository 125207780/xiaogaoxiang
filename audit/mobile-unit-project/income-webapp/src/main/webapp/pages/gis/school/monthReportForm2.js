...
function monthReportForm2DetailListGrid(){
	var lastMonth = monthInitDate2();
	   ...
	   grid.jqGrid({ 
		   ...
		   height : 200,
		   width:($("#gview_monthReportForm2InfoListGrid").width()),
		   autowidth : false,
		   ...
		   colModel: [ 
			...
			gridComplete : monthReportForm2setNiceScroll,
	 ...
	 //查询按钮
		...
		//导出
		$("#getReportForm5Export").click(function(){
			var statisMonth = encodeURI(encodeURI($("#monthAccountPeriod2").val()));
			window.location.href=$.cxt +"/getReportForm/getReportForm5Export?statisMonth="+statisMonth;
		})
}
...
function monthReportForm2setNiceScroll(){
