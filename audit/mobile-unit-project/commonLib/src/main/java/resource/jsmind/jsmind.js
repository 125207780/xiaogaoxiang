...
(function($w){
    ...
    jm.util = {
        ...
        canvas:{
            ...
            lineto1 : function(ctx,x1,y1,x2,y2){
                ctx.beginPath();
                ctx.moveTo(x1,y1);
                ctx.lineTo(x1,y2);
                ctx.stroke();
    ...
    jm.prototype={
        ...
        changeLine:function(flag){
            this.view.show_lines(flag);
         },
...
// ============= data provider =============================================
    ...
    jm.view_provider.prototype={
        ...
        show_lines:function(flag,canvas_ctx){
        	this.flag = flag
            ...
            for(var nodeid in nodes){
                ...
                this.draw_line(pout,pin,_offset,canvas_ctx,this.flag);
            }
        },

        draw_line:function(pin,pout,offset,canvas_ctx,flag){
            var ctx = canvas_ctx || this.canvas_ctx;
