...
(function() {
    /** 
     * @exports SearchSchoolControlas BMapLib.SearchSchoolControl
     */
	
    var SearchSchoolControl  = 
    

    BMapLib.SearchSchoolControl=  function(orgId) {
      
       this.orgId=orgId;
    }

    SearchSchoolControl.prototype = new BMap.Control();

    SearchSchoolControl.prototype.initialize = function(map) {
        this._map = map;
        var me=this;
        ...
        // 创建一个DOM元素
  	  var div =$("<div  style='left: 10px; top: 10px; right: auto; bottom: auto; position: absolute; -ms-text-size-adjust: none;' ></div>")
  	  
  	  var textInput = $('<input class="msc_input"  type="text">');
   	...
   	div.append(clearBtn);
   	 ...
   	 var searchBtn = $('<button class="btn btn-info msc_serchBtn" title="搜索">	<i class="fa fa-search"></i> </button>')
 	...
 	div.append(totalDiv);
  	 ...
  	 $.ajax({
			url : $.cxt + "/gridCommon/initSchoolName", 
    ...
    return polygon;
  	...
  	function search(keyword,page){ 
  	  ...
  	  searchArr=[];
  	  $.ajax({
  			url : $.cxt + "/gridCommon/selectSchoolList", 
  			...
  			success : function(json) {
  				...
  				totalDiv.append("共找到"+records+"个搜索结果");
  						...
  						var point = new BMap.Point(lng,lat);
  						  ...
  						  marker.addEventListener("click",function(e){
   							...
   							topwindow.showWindow({
								   title : '学校信息',
								   data:{physicalId:me.uid,level:"2"},
...
//  							 
    ...
    BMapLib.SearchSchoolControl= SearchSchoolControl; // 向命名空间注册.
})()
