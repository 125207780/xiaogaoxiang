...
<body>
    <div  style="height: 100%;width: 100%;text-align: center;"><font color="#fffff" size="5">各高校校园客户情况日通报报表 </font></div>
    <div style="height: 100%;width: 100%;" id="dailyReport1">
       <div class="grid-search-div clearfix no-padding">
             <div class="pull-left" style="margin-left: 0%;margin-top: 7px;"> 
               <font color=#FFFFFF> 日&nbsp;&nbsp;&nbsp;&nbsp;期：</font>
           		<input type="text" class="form-control" id="AccountPeriod1"  placeholder="请输入日期" style="width: 140px;top: -20px;left: 50px;height:25px;" data-date-format="yyyy-mm-dd" >
            </div>
            <div style="width:auto;top: 10.5%;right:81%;position: absolute;">
            	<button class="btn btn-primary" id="dailySearchList1">查询</button>
            </div>
            <div style="width:auto;top: 10.5%;right:76%;position: absolute;">
            	<button class="btn btn-primary" id="getReportForm1Export">导出</button>
            </div>
            
        </div>
        <div class="left">
            <table id="dailyReportForm1InfoListGrid"></table>
	         <div id="dailyReportForm1InfoListPagers"></div> 
        </div>
    </div>
</body>
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/gis/school/dailyReportForm1.js"></script>
</html>