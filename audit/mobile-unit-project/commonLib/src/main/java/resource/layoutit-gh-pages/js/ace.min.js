...
"vars" in window.ace || (window.ace.vars = {
    ...
    ace.general_things = function(e) {
        ...
        a && e(document).on("settings.ace.reset_scroll",
            function(a, t) {
        ...
        if (ace.vars.webkit) {
            ...
            s && e(window).on("resize.webkit",
                function() {
                    ace.helper.redraw(s)
                })
        }
        ace.vars.ios_safari && e(document).on("ace.settings.ios_fix",
            function(a, t, i) {
                "navbar_fixed" == t && (e(document).off("focus.ios_fix blur.ios_fix", "input,textarea,.wysiwyg-editor"), 1 == i && e(document).on("focus.ios_fix", "input,textarea,.wysiwyg-editor",
                    function() {
                        e(window).on("scroll.ios_fix",
                            function() {
                                var a = e("#navbar").get(0);
                                a && ace.helper.redraw(a)
                            })
                    }).on("blur.ios_fix", "input,textarea,.wysiwyg-editor",
                    function() {
    ...
    ace.helper.removeStyle = "removeProperty" in document.documentElement.style ?
        function(e, a) {
    ...
    ace.enable_ajax_content = function(e, a) {
            ...
            if (e(document).trigger(r = e.Event("ajaxloadstart"), {
                ...
                p.css({
                    ...
                    e.ajax({
                        ...
                        v.css("opacity", .8),
                            e(document).on("ajaxscriptsloaded",
                                function() {
                                    v.css("opacity", 1),
                        ...
                        if (o.length > 0) {
                            ...
                            p.length > 0 && (u && (p.find(".active").each(function() {
                                var a = "active"; (e(this).hasClass("hover") || h) && (a += " open"),
        ...
        e(window).off("hashchange.ajax").on("hashchange.ajax",
            function(a, i) {
    ...
    ace.load_ajax_scripts = function(e, a) {
        jQuery.ajaxPrefilter("script",
            ...
            setTimeout(function() {
                    ...
                    for (var t = [], i = 0; i < e.length; i++) e[i] && !
                        function() {
        ...
        if (e.fn.ace_scroll) {
            ...
            if (l && c) {
                    ...
                    H = ace.helper.sidebar_scroll = {
                        ...
                        initiate: function(a) {
                            if (!b && T) {
                                ...
                                x === !0 && h.addClass("scrollout"),
                                    ...
                                    s.on("mousewheel.ace_scroll DOMMouseScroll.ace_scroll",
                                        function(e) {
                                            return h.trigger(e)
                                        });
                                var i = v.get(0);
                                if (s.on("ace_drag.nav",
                                        function(e) {
                                        ...
                                        }), C && s.on("touchstart.nav MSPointerDown.nav pointerdown.nav",
                                        function() {
                                            s.css("transition-property", "none"),
                                                f.css("transition-property", "none")
                                        }).on("touchend.nav touchcancel.nav MSPointerUp.nav MSPointerCancel.nav pointerup.nav pointercancel.nav",
                                        function() {
                                            s.css("transition-property", "top"),
                                                f.css("transition-property", "top")
                                        }), t && !y) {
                                    var o = n.get(0);
                                    o && v.on("scroll.safari",
                                        function() {
                                            ace.helper.redraw(o)
                                        })
                                }
                        ...
                        disable: function() {
                            ...
                            h && (h.css({
                                ...
                                parseInt(c.style.top) < 0 && C && ace.vars.transition ? s.one("transitionend.trans webkitTransitionEnd.trans mozTransitionEnd.trans oTransitionEnd.trans",
                                    function() {
                ...
                H.initiate(!0),
                    ...
                    o.on("resize.ace.scroll",
                        function() {
                            T = k(),
                                H.reset()
                        }),
                    i.on("hidden.ace.submenu shown.ace.submenu", ".submenu",
                        function(e) {
                            e.stopPropagation(),
    ...
    ace.sidebar_hoverable = function(e, a) {
            ...
            if (o) {
                if ( - 1 == m && (this.className = this.className + " pull_up"), i) {
                    ...
                    0 > f - b ? e(a).css({
                        ...
                        "overflow-x": "hidden",
                        "overflow-y": "scroll"
                    }).on("mousewheel.sub_scroll DOMMouseScroll.sub_scroll ace_drag.sub_scroll",
                        function(e) {
                            e.stopPropagation()
                        }) : e(a).css({
                        "max-height": "",
                        "overflow-x": "",
                        "overflow-y": ""
                    }).off("mousewheel.sub_scroll DOMMouseScroll.sub_scroll ace_drag.sub_scroll",
                        function(e) {
                            e.stopPropagation()
                        })
                }
        ...
        if ("querySelector" in document && "removeProperty" in document.documentElement.style) {
            ...
            var s = "getComputedStyle" in window ?
                function(e, a) {
            ...
            n.on("mouseenter.ace_hover", ".nav-list li.hsub",
                function() {
            ...
            this.reload = function() {
                ...
                this.toggle = function(e, a) {
                    ...
                    if ("undefined" == typeof a && (a = t.find("> .widget-header a[data-action=collapse]").eq(0), 0 == a.length && (a = null)), a) {
                        ...
                        var o, l = null,
                            c = null; (l = s.attr("data-icon-show")) ? c = s.attr("data-icon-hide") : (o = s.attr("class").match(/fa\-(.*)\-(up|down)/)) && (l = "fa-" + o[1] + "-down", c = "fa-" + o[1] + "-up")
                    }
                    var d = 250,
                        u = 200;
                    "show" == n ? (s && s.removeClass(l).addClass(c), i.hide(), t.removeClass("collapsed"), i.slideDown(d,
                        function() {
                            t.trigger(r + ".ace.widget")
                        })) : (s && s.removeClass(c).addClass(l), i.slideUp(u,
                        function() {
    ...
    ace.enable_searchbox_autocomplete = function(e) {
        ace.vars.US_STATES = ["北京", "长春", "哈尔滨", "济南", "重庆", "吉林", "天津", "南京", "成都", "上海", "沈阳", "乌鲁木齐", "拉萨", "太原", "杭州", "福州", "广州", "深圳", "珠海", "澳门", "台北", "香港", "中山", "长沙", "合肥", "银川", "昆明", "南宁", "唐山", "诸暨", "石家庄", "南昌", "武汉", "苏州", "芜湖", "青岛", "威海", "大连", "包头", "齐齐哈尔", "牡丹江", "海口", "三亚", "三沙", "厦门", "开封", "郑州", "贵阳市", "西安市", "呼和浩特市"];
        try {
