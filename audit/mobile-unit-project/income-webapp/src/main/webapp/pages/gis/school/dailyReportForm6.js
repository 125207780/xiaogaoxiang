...
function dailyReportForm6DetailListGrid(){
	var lastMonth = dailyInitDate6();
	   ...
	   grid.jqGrid({ 
		   ...
		   height : 200,
		   width:($("#gview_dailyReportForm6InfoListGrid").width()),
		   autowidth : false,
		   ...
		   colModel: [ 
			...
			gridComplete : dailyReportForm6setNiceScroll,
	 ...
	 //导出
		$("#getReportForm14Export").click(function(){
			var statisMonth = encodeURI(encodeURI($("#dailyAccountPeriod6").val()));
			window.location.href=$.cxt +"/getReportForm/getReportForm14Export?statisMonth="+statisMonth;
		})
}
...
function dailyReportForm6setNiceScroll(){
