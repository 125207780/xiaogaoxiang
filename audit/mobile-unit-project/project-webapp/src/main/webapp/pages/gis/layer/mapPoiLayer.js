...
(function() {
     ...
     */
    var PoiLayer = BMapLib.PoiLayer = function(orgId, flag) {
    	this.conf = {};
    	this.overlayList = [];
		...
		$.ajax({
			...
			success: function(list) {
				...
				if(null != list && list.length > 0) {
					...
					while(len--) {
						try {
							shape = list[len].shape;
							polygon = me.transformVMap(shape);
	...
	PoiLayer.prototype.addEventListener = function(event, fun) {
	...
	PoiLayer.prototype.getOverlayList = function () {
