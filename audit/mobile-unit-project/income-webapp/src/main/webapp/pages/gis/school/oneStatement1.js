...
function oneStatement1DetailListGrid(){
	var lastMonth = oneInitDate1();
	   ...
	   grid.jqGrid({ 
		   ...
		   height : 200,
		   width:($("#gview_oneStatement1InfoListGrid").width()),
		   autowidth : false,
		   ...
		   colModel: [ 
			...
			gridComplete : setNiceScrollOne1,
	 ...
	 //查询按钮
		...
		//导出
		$("#getReportForm11Export").click(function(){
			var statisMonth = encodeURI(encodeURI($("#oneAccountPeriod1").val()));
			window.location.href=$.cxt +"/getReportForm/getReportForm11Export?statisMonth="+statisMonth;
		})
}
...
function setNiceScrollOne1(){
	$('#gbox_oneStatement1InfoListGrid .ui-jqgrid-view .ui-jqgrid-bdiv').getNiceScroll().resize()
	...
	$("#gbox_oneStatement1InfoListGrid .ui-jqgrid-view .ui-jqgrid-bdiv").niceScroll({
